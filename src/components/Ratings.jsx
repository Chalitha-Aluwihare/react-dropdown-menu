  ...
  const ratings = [
    {
      ...
      starts: (
        <>
          <div className="flex">
            <FaStar className="fill-gray-500 size-[11px]" />
            <FaStar className="fill-gray-500 size-[11px]" />
            <FaStar className="fill-gray-500 size-[11px]" />
            <FaStar className="fill-gray-500 size-[11px]" />
            <TiStarHalfOutline className="fill-gray-500 size-[11px]" />
          </div>
        </>
      ),
    },
          ...
          <div className="absolute mt-1 bg-gray-200 rounded-xl ">
            ...
            {ratings.map((item) => {
              return (
                ...
                >
                  <div className=" w-[135px] items-center justify-between flex rounded-full">
                    <span className="text-gray-500 text-[11px] m-2">
                      {item.rating}
                    </span>
